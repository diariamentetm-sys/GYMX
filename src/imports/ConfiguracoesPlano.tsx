import svgPaths from "./svg-5lwylrdy1c";
...
function Icon2() {
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_6_3568)" id="Icon">
          <path d={svgPaths.p22f2b900} id="Vector" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M1.33301 6.66504H14.6631" id="Vector_2" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
        </g>
        <defs>
...
function Button2() {
  return (
    <div className="bg-[#e8271a] h-[39.993px] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-[100.866px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon2 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[62.49px] not-italic text-[#f2f2f2] text-[14px] text-center top-[10.25px] whitespace-nowrap">Planos</p>
      </div>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_5_2974)" id="Icon">
          <path d={svgPaths.pbe3d0f0} id="Vector" stroke="var(--stroke-0, #A8A8A8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
        </g>
        <defs>
          <clipPath id="clip0_5_2974">
            <rect fill="white" height="15.9961" width="15.9961" />
          </clipPath>
        </defs>
      </svg>
...
function Button3() {
  return (
    <div className="h-[39.993px] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-[109.329px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon3 />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[66.99px] not-italic text-[#a8a8a8] text-[14px] text-center top-[10.25px] whitespace-nowrap">Sistema</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[27.995px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Barlow_Condensed:Bold',sans-serif] leading-[28px] left-0 not-italic text-[#f2f2f2] text-[20px] top-[-0.33px] tracking-[-0.5px] whitespace-nowrap">PLANOS E PREÇOS</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">Configure os planos disponíveis para os alunos. As alterações refletem em todo o sistema.</p>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="content-stretch flex h-[27.988px] items-center overflow-clip relative shrink-0 w-full" data-name="Text Input">
      <p className="font-['Barlow_Condensed:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#f2f2f2] text-[18px] tracking-[-0.45px] whitespace-nowrap">BASIC</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="content-stretch flex h-[15.996px] items-center overflow-clip relative shrink-0 w-full" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(168,168,168,0.5)] whitespace-nowrap">Plano básico</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="h-[51.992px] relative shrink-0 w-[475.371px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[5.417px] items-start relative size-full">
        <TextInput />
        <TextInput1 />
      </div>
    </div>
...
function NumberInput() {
  return (
    <div className="bg-[#0d0d0d] h-[37.65px] relative rounded-[10px] shrink-0 w-[111.999px]" data-name="Number Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">89.9</p>
      </div>
...
function Container10() {
  return (
    <div className="h-[37.65px] relative shrink-0 w-[139.993px]" data-name="Container">
...
function Container9() {
  return (
    <div className="h-[37.65px] relative shrink-0 w-[183.978px]" data-name="Container">
...
function Container7() {
  return (
    <div className="h-[51.992px] relative shrink-0 w-full" data-name="Container">
...
function Text() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Acesso à área de musculação</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex h-[19.993px] items-center left-0 pr-[51.979px] top-0 w-[675.345px]" data-name="Container">
      <Text />
    </div>
  );
}
...
function Text1() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Horário livre</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute content-stretch flex h-[19.993px] items-center left-0 pr-[51.979px] top-[27.99px] w-[675.345px]" data-name="Container">
      <Text1 />
    </div>
  );
}
...
function Text2() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Armário individual</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute content-stretch flex h-[19.993px] items-center left-0 pr-[51.979px] top-[55.98px] w-[675.345px]" data-name="Container">
      <Text2 />
    </div>
  );
}
...
function Icon5() {
  return (
    <div className="absolute left-0 size-[15.996px] top-[2px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g id="Icon">
          <path d="M3.33252 7.99805H12.6636" id="Vector" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M7.99805 3.33252V12.6636" id="Vector_2" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="absolute h-[19.993px] left-0 top-[83.96px] w-[154.03px]" data-name="Button">
      <Icon5 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[88.99px] not-italic text-[#606060] text-[14px] text-center top-[0.25px] whitespace-nowrap">Adicionar benefício</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="h-[103.958px] relative shrink-0 w-full" data-name="Container">
      <Container12 />
      <Container13 />
      <Container14 />
      <Button4 />
...
function Container6() {
  return (
    <div className="absolute bg-[#1a1a1a] content-stretch flex flex-col gap-[15.996px] h-[213.613px] items-start left-0 pb-[0.833px] pt-[20.833px] px-[20.833px] rounded-[10px] top-0 w-[717.012px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container7 />
      <Container11 />
    </div>
...
function TextInput2() {
  return (
    <div className="content-stretch flex h-[27.988px] items-center overflow-clip relative shrink-0 w-full" data-name="Text Input">
      <p className="font-['Barlow_Condensed:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#e8271a] text-[18px] tracking-[-0.45px] whitespace-nowrap">PREMIUM</p>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="content-stretch flex h-[15.996px] items-center overflow-clip relative shrink-0 w-full" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(168,168,168,0.5)] whitespace-nowrap">Plano mais popular</p>
    </div>
  );
}
...
function NumberInput1() {
  return (
    <div className="bg-[#0d0d0d] h-[37.65px] relative rounded-[10px] shrink-0 w-[111.999px]" data-name="Number Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">199.9</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Text3() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Tudo do plano BASIC</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Aulas coletivas ilimitadas</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Avaliação física mensal</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Treino personalizado</p>
      </div>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[19.993px] items-center left-0 pr-[51.979px] top-[83.96px] w-[675.345px]" data-name="Container">
      <Text6 />
    </div>
  );
}
...
function Button5() {
  return (
    <div className="absolute h-[19.993px] left-0 top-[111.95px] w-[154.03px]" data-name="Button">
      <Icon7 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[88.99px] not-italic text-[#606060] text-[14px] text-center top-[0.25px] whitespace-nowrap">Adicionar benefício</p>
    </div>
  );
...
function Container20() {
  return (
    <div className="h-[131.947px] relative shrink-0 w-full" data-name="Container">
      <Container21 />
      <Container22 />
      <Container23 />
      <Container24 />
...
function Container15() {
  return (
    <div className="absolute bg-[#1a1a1a] content-stretch flex flex-col gap-[15.996px] h-[241.602px] items-start left-0 pb-[0.833px] pt-[20.833px] px-[20.833px] rounded-[10px] top-[229.61px] w-[717.012px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.833px] border-[rgba(232,39,26,0.3)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container16 />
      <Container20 />
    </div>
  );
...
function TextInput4() {
  return (
    <div className="content-stretch flex h-[27.988px] items-center overflow-clip relative shrink-0 w-full" data-name="Text Input">
      <p className="font-['Barlow_Condensed:Bold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#e8271a] text-[18px] tracking-[-0.45px] whitespace-nowrap">ELITE</p>
    </div>
  );
}
...
function TextInput5() {
  return (
    <div className="content-stretch flex h-[15.996px] items-center overflow-clip relative shrink-0 w-full" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[12px] text-[rgba(168,168,168,0.5)] whitespace-nowrap">Plano completo</p>
    </div>
  );
}
...
function NumberInput2() {
  return (
    <div className="bg-[#0d0d0d] h-[37.65px] relative rounded-[10px] shrink-0 w-[111.999px]" data-name="Number Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">299.9</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Text7() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Tudo do plano PREMIUM</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Personal trainer 2x por semana</p>
      </div>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Acompanhamento nutricional</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Acesso a unidades parceiras</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="flex-[623.366_0_0] h-[19.993px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">• Bebidas proteicas gratuitas</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute content-stretch flex h-[19.993px] items-center left-0 pr-[51.979px] top-[111.95px] w-[675.345px]" data-name="Container">
      <Text11 />
    </div>
  );
}
...
function Button6() {
  return (
    <div className="absolute h-[19.993px] left-0 top-[139.94px] w-[154.03px]" data-name="Button">
      <Icon9 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[88.99px] not-italic text-[#606060] text-[14px] text-center top-[0.25px] whitespace-nowrap">Adicionar benefício</p>
    </div>
  );
...
function Container30() {
  return (
    <div className="h-[159.935px] relative shrink-0 w-full" data-name="Container">
      <Container31 />
      <Container32 />
      <Container33 />
      <Container34 />
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15.996px] h-[269.59px] items-start left-0 pb-[0.833px] pt-[20.833px] px-[20.833px] rounded-[10px] top-[487.21px] w-[717.012px]" data-name="Container" style={{ backgroundImage: "linear-gradient(159.394deg, rgba(232, 39, 26, 0.1) 0%, rgba(232, 39, 26, 0.05) 100%)" }}>
      <div aria-hidden="true" className="absolute border-[0.833px] border-[rgba(232,39,26,0.5)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container26 />
      <Container30 />
    </div>
  );
...
function Icon10() {
  return (
    <div className="absolute left-[24px] size-[15.996px] top-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g id="Icon">
...
function Button7() {
  return (
    <div className="absolute bg-[#e8271a] h-[44.004px] left-0 rounded-[10px] top-[772.79px] w-[200.566px]" data-name="Button">
      <Icon10 />
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[111.99px] not-italic text-[#f2f2f2] text-[16px] text-center top-[9.08px] whitespace-nowrap">Criar Novo Plano</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="h-[816.797px] relative shrink-0 w-full" data-name="Container">
      <Container6 />
      <Container15 />
      <Container25 />
      <Button7 />
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[23.997px] h-[904.779px] items-start relative shrink-0 w-full" data-name="Container">
      <Container4 />
      <Container5 />
    </div>
  );
...
function Container2() {
  return (
    <div className="bg-[#0d0d0d] h-[1056.94px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function ConfiguracoesScreen() {
  return (
    <div className="absolute bg-[#090909] content-stretch flex flex-col gap-[23.997px] h-[1358.587px] items-start left-0 pl-[287.995px] pr-[31.999px] pt-[112.832px] top-0 w-[1086.667px]" data-name="ConfiguracoesScreen">
      <Container />
      <Container1 />
      <Container2 />
    </div>
...
export default function ConfiguracoesPlano() {
  return (
    <div className="bg-white relative size-full" data-name="configurações-plano">
      <ConfiguracoesScreen />
      <DashboardAdmin />
      <DashboardAdmin1 />
      <DashboardAdmin2 />
