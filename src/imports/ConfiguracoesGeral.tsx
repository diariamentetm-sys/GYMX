import svgPaths from "./svg-qabrutz0l1";
  ...
  return (
    <div className="absolute left-[16px] size-[15.996px] top-[12px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9961 15.9961">
        <g clipPath="url(#clip0_5_2998)" id="Icon">
          <path d={svgPaths.p1ef99000} id="Vector" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d={svgPaths.pea80900} id="Vector_2" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d={svgPaths.p26eb4b00} id="Vector_3" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M6.66504 3.99902H9.33105" id="Vector_4" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M6.66504 6.66504H9.33105" id="Vector_5" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M6.66504 9.33105H9.33105" id="Vector_6" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
          <path d="M6.66504 11.9971H9.33105" id="Vector_7" stroke="var(--stroke-0, #F2F2F2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
        </g>
        <defs>
          <clipPath id="clip0_5_2998">
...
function Button() {
  return (
    <div className="bg-[#e8271a] h-[39.993px] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-[91.497px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[57.99px] not-italic text-[#f2f2f2] text-[14px] text-center top-[10.25px] whitespace-nowrap">Geral</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[27.995px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Barlow_Condensed:Bold',sans-serif] leading-[28px] left-0 not-italic text-[#f2f2f2] text-[20px] top-[-0.33px] tracking-[-0.5px] whitespace-nowrap">INFORMAÇÕES DA ACADEMIA</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#a8a8a8] text-[14px] top-[0.25px] whitespace-nowrap">Configure os dados básicos da sua academia</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">Nome da Academia</p>
    </div>
  );
}
...
function TextInput() {
  return (
    <div className="absolute bg-[#1a1a1a] h-[45.658px] left-0 rounded-[10px] top-0 w-[346.504px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">PulseGym Academia</p>
      </div>
  ...
  return (
    <div className="absolute left-[12px] size-[20px] top-[12.83px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_5_2989)" id="Icon">
          <path d={svgPaths.p37143280} id="Vector" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1d7f0000} id="Vector_2" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2b722f80} id="Vector_3" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 5H11.6667" id="Vector_4" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 8.33333H11.6667" id="Vector_5" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 11.6667H11.6667" id="Vector_6" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 15H11.6667" id="Vector_7" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-0 top-0 w-[346.504px]" data-name="Container">
      <Label />
      <Container7 />
    </div>
  );
...
function Label1() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">CNPJ</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="absolute bg-[#1a1a1a] h-[45.658px] left-0 rounded-[10px] top-0 w-[346.51px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">12.345.678/0001-90</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Icon5() {
  return (
    <div className="absolute left-[12px] size-[20px] top-[12.83px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p25fc4100} id="Vector" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-[370.5px] top-0 w-[346.51px]" data-name="Container">
      <Label1 />
      <Container9 />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">Telefone</p>
    </div>
  );
}
...
function PhoneInput() {
  return (
    <div className="absolute bg-[#1a1a1a] h-[45.658px] left-0 rounded-[10px] top-0 w-[346.504px]" data-name="Phone Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">(11) 3456-7890</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Icon6() {
  return (
    <div className="absolute left-[12px] size-[20px] top-[12.83px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_5_3007)" id="Icon">
          <path d={svgPaths.p1a7ce800} id="Vector" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
...
function Container10() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-0 top-[97.64px] w-[346.504px]" data-name="Container">
      <Label2 />
      <Container11 />
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">Email</p>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="absolute bg-[#1a1a1a] h-[45.658px] left-0 rounded-[10px] top-0 w-[346.51px]" data-name="Email Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">contato@pulsegym.com.br</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Icon7() {
  return (
    <div className="absolute left-[12px] size-[20px] top-[12.83px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.pd919a80} id="Vector" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p189c1170} id="Vector_2" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-[370.5px] top-[97.64px] w-[346.51px]" data-name="Container">
      <Label3 />
      <Container13 />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">Endereço</p>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute bg-[#1a1a1a] h-[45.658px] left-0 rounded-[10px] top-0 w-[717.012px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[44px] pr-[16px] py-[12px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">Rua das Academias, 123 - Centro</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
  );
...
function Icon8() {
  return (
    <div className="absolute left-[12px] size-[20px] top-[12.83px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p26ddc800} id="Vector" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p35ba4680} id="Vector_2" stroke="var(--stroke-0, #606060)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-0 top-[195.29px] w-[717.012px]" data-name="Container">
      <Label4 />
      <Container15 />
    </div>
  );
...
function Label5() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">Cidade</p>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-[#1a1a1a] h-[45.658px] relative rounded-[10px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">São Paulo</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function Container16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-0 top-[292.93px] w-[346.504px]" data-name="Container">
      <Label5 />
      <TextInput3 />
    </div>
  );
...
function Label6() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">Estado</p>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="bg-[#1a1a1a] h-[45.658px] relative rounded-[10px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">SP</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function Container18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-0 top-0 w-[165.254px]" data-name="Container">
      <Label6 />
      <TextInput4 />
    </div>
  );
...
function Label7() {
  return (
    <div className="h-[19.993px] relative shrink-0 w-full" data-name="Label">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#f2f2f2] text-[14px] top-[0.25px] whitespace-nowrap">CEP</p>
    </div>
  );
}
...
function TextInput5() {
  return (
    <div className="bg-[#1a1a1a] h-[45.658px] relative rounded-[10px] shrink-0 w-full" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f2f2f2] text-[14px] whitespace-nowrap">01234-567</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#303030] border-[0.833px] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function Container19() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[73.646px] items-start left-[181.25px] top-0 w-[165.26px]" data-name="Container">
      <Label7 />
      <TextInput5 />
    </div>
  );
...
function Container17() {
  return (
    <div className="absolute h-[73.646px] left-[370.5px] top-[292.93px] w-[346.51px]" data-name="Container">
      <Container18 />
      <Container19 />
    </div>
  );
...
function Container5() {
  return (
    <div className="h-[366.576px] relative shrink-0 w-full" data-name="Container">
      <Container6 />
      <Container8 />
      <Container10 />
      <Container12 />
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[23.997px] h-[454.557px] items-start relative shrink-0 w-full" data-name="Container">
      <Container4 />
      <Container5 />
    </div>
  );
...
function Container2() {
  return (
    <div className="bg-[#0d0d0d] h-[606.719px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function ConfiguracoesScreen() {
  return (
    <div className="absolute bg-[#090909] content-stretch flex flex-col gap-[23.997px] h-[908.366px] items-start left-0 pl-[287.995px] pr-[31.999px] pt-[112.832px] top-0 w-[1086.667px]" data-name="ConfiguracoesScreen">
      <Container />
      <Container1 />
      <Container2 />
    </div>
...
export default function ConfiguracoesGeral() {
  return (
    <div className="bg-white relative size-full" data-name="configurações-geral">
      <ConfiguracoesScreen />
      <DashboardAdmin />
      <DashboardAdmin1 />
      <DashboardAdmin2 />
